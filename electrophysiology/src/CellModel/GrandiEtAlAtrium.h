...
#ifdef HETERO
# define v(a) PS->getValue(NS_GrandiEtAlAtriumParameters::a)
#else  // ifdef HETERO
# define v(a) ptTeaP->P[NS_GrandiEtAlAtriumParameters::a].value
#endif  // ifdef HETERO

class GrandiEtAlAtrium : public vbElphyModel<ML_CalcType> {
 public:
  GrandiEtAlAtriumParameters *ptTeaP;
  ML_CalcType Na_j;
  ML_CalcType Na_sl;
  ML_CalcType K_i;
  ML_CalcType Ca_j;
...
};  // class GrandiEtAlAtrium
#endif  // ifndef GRANDIETALATRIUM
