/*
 * File: GrandiEtAlVentricleParameters.h
 *
...
#ifndef GRANDIETALVENTRICLEPARAMETERS_H
#define GRANDIETALVENTRICLEPARAMETERS_H

#include <ParameterLoader.h>

namespace NS_GrandiEtAlVentricleParameters {
enum varType {
...
using namespace NS_GrandiEtAlVentricleParameters;

class GrandiEtAlVentricleParameters : public vbNewElphyParameters {
 public:
  GrandiEtAlVentricleParameters(const char *, ML_CalcType);
  ~GrandiEtAlVentricleParameters();
  ...
  ML_CalcType exptauxtos[RTDT];
  ML_CalcType ytoss[RTDT];
  ML_CalcType exptauytos[RTDT];
...
};  // class GrandiEtAlVentricleParameters

#endif  // ifndef GRANDIETALVENTRICLEPARAMETERS_H
