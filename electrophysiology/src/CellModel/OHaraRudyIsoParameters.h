...
#ifndef OHARARUDYISOPARAMETERS_H
#define OHARARUDYISOPARAMETERS_H

/// OHara Rudy model variations.
/// PKA Phosphorylation by Gong et al. 2020 Implemented by Jan-Erik Duhme
#define PKA
...
using namespace NS_OHaraRudyIsoParameters;

class OHaraRudyIsoParameters : public vbNewElphyParameters {
 public:
  OHaraRudyIsoParameters(const char *, ML_CalcType);
  ~OHaraRudyIsoParameters();
  ...
  ML_CalcType h_PKA_inf[RTDT];
  ML_CalcType j_PKA_inf[RTDT];
  ML_CalcType h_both_inf[RTDT];
  ML_CalcType exptau_h_both_fast[RTDT];
  ML_CalcType exptau_h_both_slow[RTDT];
  ML_CalcType j_both_inf[RTDT];
  ML_CalcType exptau_j_both[RTDT];
  ...
  ML_CalcType x_s1_PKA_inf[RTDT];
  ML_CalcType exptau_x_s1_PKA[RTDT];
  ML_CalcType x_s2_PKA_inf[RTDT];
  ML_CalcType exptau_x_s2_PKA[RTDT];
  ML_CalcType x_K1_inf[RTDT];
  ML_CalcType exptau_x_K1[RTDT];
  ML_CalcType R_K1[RTDT];
  ML_CalcType x_Kb[RTDT];
};  // class OHaraRudyIsoParameters
